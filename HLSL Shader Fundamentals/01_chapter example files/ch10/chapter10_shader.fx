...
//Chapter 10: Structure of the FX Framework - Techniques and Passes
...
float4 f(v2f In,uniform float4 lightColor) : COLOR
{
  ...
  C += lightColor * blinn2(N, L, V, DiffuseColor, SpecularColor, Glossiness);	//we pass all our values to the lighting function and multiply by the light color to get our final output color
