...
//Chapter 8: Structure of the FX Framework - Input and Output Structs
...
Matrices Avialable From Max

   1. World
   2. WorldInverse
   3. WorldInverseTranspose
   4. View
   5. ViewInverse
   6. ViewInverseTranspose
   7. Projection
   8. ProjectionInverse
   9. ProjectionInverseTranspose
  10. WorldView
  11. WorldViewInverse
  12. WorldViewInverseTranspose
  13. WorldViewProjection
  14. WorldViewProjectionInverse
  15. WorldViewProjectionInverseTranspose
...
/*
Available Input Semantics (there are others but these are the ones that Max supports)
	1. POSITION
	2. TEXCOORD0-7
	3. NORMAL
	4. BINORMAL
...
/*
Available Ouput Semantics (there are others but these are the ones that Max supports)
	1. POSITION
	2. TEXCOORD0-7
	3. COLOR
*/
