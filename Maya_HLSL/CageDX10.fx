...
> {
    ...
    > {
        SetVertexShader( CompileShader( vs_4_0, mainVS(gWvpXf,gWorldXf,
				gScale) ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, strokeTexPS(gWireColor,gEmptyColor,
		    gBalance,gStripeSampler) ) );
